...
cell = lib.new_cell('DBR-PCSEL-CONFIG-II')
...
# =============================================================================
# structure 9: PCSEL with 7 periods of DBR, finwidth 1 micron, Ncore = 5
# =============================================================================
...
# =============================================================================
# structure 10: PCSEL with 7 periods of DBR, finwidth 1 micron, Ncore = 10
# =============================================================================
...
# =============================================================================
# structure 11: PCSEL with 8 periods of DBR , finwidth 3 micron, Ncore = 5
# =============================================================================
...
# =============================================================================
# structure 12: PCSEL with 8 periods of DBR, finwidth 1 micron, Ncore = 5
# =============================================================================
...
# =============================================================================
# structure 13: PCSEL with 8 periods of DBR, finwidth 2 micron, Ncore = 5
# =============================================================================
...
lib.write_gds('DBRs_PCSEL_Config.II.gds')

# Optionally, save an image of the cell as SVG.
cell.write_svg('DBRs_PCSEL_Config.II.svg')
